{
  ...
  outputs = { self, nixpkgs, home-manager, ... }:
    let
      ...
      email =
        "ceredi.simone.iti@gmail.com"; # email (used for certain configurations)
      wm =
        "i3"; # Selected window manager or desktop environment; must select one in both ./user/wm/ and ./system/wm/
